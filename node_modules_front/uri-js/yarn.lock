...
babel-register@^6.26.0:
  ...
  integrity sha1-btAhFz4vy0htestFxgCahW9kcHE= sha512-veliHlHX06wjaeY8xNITbveXSiI+ASFnOqvne/LaIJIqOWi2Ogmj91KOugEz/hoh/fwMhXNBJPCv8Xaz5CyM4A==
  dependencies:
    babel-core "^6.26.0"
    babel-runtime "^6.26.0"
    core-js "^2.5.0"
...
home-or-tmp@^2.0.0:
  ...
  integrity sha1-42w/LSyufXRqhX440Y1fMqeILbg= sha512-ycURW7oUxE2sNiPVw1HVEFsW+ecOpJ5zaj7eC0RlwhibhRBod20muUN8qu/gzx956YrLolVvs1MTXwKgC2rVEg==
  dependencies:
    os-homedir "^1.0.0"
    os-tmpdir "^1.0.1"
...
mocha-qunit-ui@^0.1.3:
  version "0.1.3"
  resolved "https://registry.npmjs.org/mocha-qunit-ui/-/mocha-qunit-ui-0.1.3.tgz"
...
output-file-sync@^1.1.2:
  ...
  integrity sha1-0KM+7+YaIF+suQCS6CZZjVJFznY= sha512-uQLlclru4xpCi+tfs80l3QF24KL81X57ELNMy7W/dox+JTtxUf1bLyQ8968fFCmSqqbokjW0kn+WBIlO+rSkNg==
  dependencies:
    graceful-fs "^4.1.4"
    mkdirp "^0.5.1"
    object-assign "^4.1.0"
...
regenerator-runtime@^0.10.5:
  ...
  integrity sha1-M2w+/BIgrc7dosn6tntaeVWjNlg= sha512-02YopEIhAgiBHWeoTiA8aitHDt8z6w+rQqNuIftlM+ZtvSl/brTouaU7DW6GO/cHtvxJvS4Hwv2ibKdxIRi24w==
...
user-home@^1.1.1:
  ...
  integrity sha1-K1viOjK2Onyd640PKNSFcko98ZA= sha512-aggiKfEEubv3UwRNqTzLInZpAOmKzwdHqEBmW/hBA/mt99eg+b4VrX6i+IRLxU8+WJYfa33rGwRseg4eElUgsQ==
...
v8flags@^2.1.1:
  ...
  integrity sha1-qrGh+jDUX4jdMhFIh1rALAtV5bQ= sha512-SKfhk/LlaXzvtowJabLZwD4K6SGRYeoxA7KJeISlUMAB/NT4CBkZjMq3WceX2Ckm4llwqYVo8TICgsDYCBU2tA==
  dependencies:
    user-home "^1.1.1"
